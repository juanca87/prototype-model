...
<head>
    ...
    <script type="text/javascript" src="/client/resources/js/js-prototype-app.js"></script>
    <script src="/client/resources/js/lib/jquery.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="/client/resources/js/js-prototype-app.js"></script>
</head>
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index">Prototipo</a>
            </div>
            ...
            <div class="header-right">
                ...
                <a href="javascript:formSubmit()" class="btn btn-danger" title="Logout"><i class="fa fa-exclamation-circle fa-2x"></i></a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop "></i>UI Elements <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="dashboard"><i class="fa fa-toggle-on"></i>Tabs & Panels</a>
                            </li>
                            <li>
