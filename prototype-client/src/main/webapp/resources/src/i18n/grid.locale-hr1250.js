...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "Pretra�ivanje",
		Reset: "Poni�ti",
		odata : ['jednak', 'nije identi�an', 'manje', 'manje ili identióno','ve�e','ve�e ili identióno', 'po�inje sa','ne po�inje sa ','je u','nije u','zavr�ava sa','ne zavr�ava sa','sadr�i','ne sadr�i'],
	...
	edit : {
		...
		msg: {
			...
			minValue:"Vrijednost mora biti ve�a ili identióna ",
			maxValue:"Vrijednost mora biti manja ili identióna",
