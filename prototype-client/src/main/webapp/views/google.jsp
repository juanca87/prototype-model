...
<head>
    <title>Google Cloud Engine</title>
                ...
                <div class="navbar-collapse collapse" id="additional-nav">
                    ...
                    <sec:authorize access="isAuthenticated()">
                        <ul class="nav navbar-nav">
                            ...
                            <li id="googleAppEngine" class="active"><a href="${contextUrl}google">Google Cloud Engine</a></li>
...
<%--     <h4>Mensaje : ${mensaje}</h4> --%>
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-head-line">Caracter�sticas del Servidor</h3>
                ...
                <div id="caracteristica" class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-info-circle fa-fw"></i> Info - Google Cloud [IaaS - Infrastructure as a Service]
                            ...
                            <tr>
                                <td>
                                    <div class="table-bordered" align="center">
                                        <label style="font-size: small;">Caracter�sticas Reales</label>
                                        <table class="table" style="font-size: small;">
                                            <thead>
                                                <tr class="active">
                                                    <th>#</th>
                                ...
                                <td>
                                    <div class="table-bordered" align="center">
                                        <label style="font-size: small;">Caracter�sticas Ofrecidas</label>
                                        <table class="table" style="font-size: small;">
                                            <thead>
                                                <tr class="active">
                                                    <th>#</th>
